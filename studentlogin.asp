			...
			<div class="row" style="margin-top:5px;">
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="background-color: grey;padding:10px">
					<div class="col-xs-12 col-sm-6 col-md-12 col-lg-12" style="background-color:white;">
						<form role="form"  name="reg_form"  id="form" class="form-vertical" action="studentlogin.asp" method="POST">
							<h4 style="margin-bottom:20px;background-color:#CCFF33;padding:10px">Application Login </h4>
						<hr/>
