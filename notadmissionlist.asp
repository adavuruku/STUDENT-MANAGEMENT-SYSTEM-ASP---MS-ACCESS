			...
			<div class="row" style="margin-top:5px;">
				...
				<div class="col-xs-12 col-sm-6 col-md-8 col-lg-8" style="background-color: grey;padding:10px;margin-bottom:10px">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="background-color:white;">
						<h4 style="text-align:center; font-weight:bold">LIST OF PENDING STUDENT APPLICATION</h4>
						<%
							'*********************************************build modals
							Dim Status_C, msg1,studFaculty,studCourse, sta 
							dim studName ,studState,studReg, Item,id_link
							'check admission status
							if Request.QueryString("check") <> "" AND Request.QueryString("check") = "notadmissionlist" then
								
								Status_C = "0"
								sta = "1"
								set rs = Server.CreateObject("ADODB.recordset")
								queryS = "Select * from student_record where admissionStatus='" & Status_C & "' AND reg_status='" & sta & "' order by id desc"  
								rs.Open queryS, conn
												...
												Response.write("<div style='width:100%;' class='modal-content'>")
													...
													Response.write("<tbody>")
														Response.write("<tr>")
															...
															Response.write("<td colspan='4' align='center'><a href='notadmissionlist.asp?ausername=" & ausername & "&last_login=" & last_login & "&deleteid=" & rs.Fields.Item("appID") & "&check=notadmissionlist'><span  class='btn btn-primary hidden-print'>Grant Admission</span></a></td>")
														Response.write("</tr>")
														Response.write("<tr>")
