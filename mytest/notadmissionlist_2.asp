			...
			<div class="row" style="margin-top:5px;">
				...
				<div class="col-xs-12 col-sm-6 col-md-8 col-lg-8" style="background-color: grey;padding:10px;margin-bottom:10px">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="background-color:white;">
						<h4 style="text-align:center; font-weight:bold">LIST OF PENDING ADMISSION </h4>
						<%
							'*********************************************build modals
												...
												Response.write("<div style='width:100%;' class='modal-content'>")
													...
													Response.write("<tbody>")
														Response.write("<tr>")
															...
															Response.write("<td colspan='4'><a href='admissionlist.asp?ausername=" & ausername & "&last_login=" & last_login & "&deleteid=" & rs.Fields.Item("appID") & "&check=admissionlist'><span  class='btn btn-primary hidden-print'>Revoke</span></a></td>")
														Response.write("</tr>")
														Response.write("<tr>")
